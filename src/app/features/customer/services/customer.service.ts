...
export class CustomerService {
  ...
  getCustomers(dataListParameter: DataListParameter = {} as DataListParameter) {
    let param = '';
    ...
    return this.http.get(`${ROOT_API}/admin/customers${param}`);
  }
  getCustomer(id: string) {
    return this.http.get(`${ROOT_API}/admin/customers/${id}`);
  }
}
