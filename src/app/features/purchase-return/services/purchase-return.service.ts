...
export class PurchaseReturnService {
  ...
  setStatusAsComplete(id:string){
    return this.http.put(`${ROOT_API}/admin/purchase-returns/${id}/complete`, {});
  }

  setStatusAsCancel(id:string){
    return this.http.put(`${ROOT_API}/admin/purchase-returns/${id}/cancelled`, {});
  }

  // Purchase Return Detail
  addPurchaseReturnDetail(purchaseReturnId: string, purchaseReturnDetail: any) {
    return this.http.post(`${ROOT_API}/admin/purchase-returns/${purchaseReturnId}/details`, purchaseReturnDetail);
  }

  updatePurchaseReturnDetail(purchaseReturnId: string, purchaseReturnDetailId: string, purchaseReturnDetail: any) {
    return this.http.put(
  ...
  deletePurchaseReturnDetail(purchaseReturnId: string, purchaseReturnDetailId: string) {
    return this.http.delete(`${ROOT_API}/admin/purchase-returns/${purchaseReturnId}/details/${purchaseReturnDetailId}`);
  }
}
