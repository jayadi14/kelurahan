...
export class SupplierQuotationService {
  ...
  receiveSupplierQuotation(id: string) {
    return this.http.put(`${ROOT_API}/admin/supplier-quotations/${id}/received`, {});
  }

  cancelSupplierQuotation(id: string) {
    return this.http.put(`${ROOT_API}/admin/supplier-quotations/${id}/cancelled`, {});
  }
  ...
  createSupplierQuotationDetail(id: string, bodyReq:any){
    return this.http.post(`${ROOT_API}/admin/supplier-quotations/${id}/details`, bodyReq);
  }

  updateSupplierQuotationDetail(id: string, supplierQuotationId: any, bodyReq: any) {
    return this.http.put(
  ...
  deleteSupplierQuotationDetail(id: string, supplierQuotationId: string) {
    return this.http.delete(`${ROOT_API}/admin/supplier-quotations/${id}/details/${supplierQuotationId}`);
  }
}
